...
_import_structure = {
    ...
    "grpo_process_trainer": ["GRPOProcessTrainer"],
    "grpo_curiosity_trainer": ["GRPOCuriosityTrainer"],
    "grpo_search_trainer": ["GRPOSearchTrainer"],
    "grpo_sep_process_loss_trainer": ["GRPOProcessSepLossTrainer"],
    "grpo_sep_process_nooverlap_loss_trainer": ["GRPONoOverlapProcessSepLossTrainer"],
...
if TYPE_CHECKING:
    ...
    from .grpo_process_trainer import GRPOProcessTrainer
    from .grpo_curiosity_trainer import GRPOCuriosityTrainer
    from .grpo_search_trainer import GRPOSearchTrainer
    from .grpo_sep_process_loss_trainer import GRPOProcessSepLossTrainer
    from .grpo_sep_process_nooverlap_loss_trainer import GRPONoOverlapProcessSepLossTrainer
